...
import { Camera, Mic, MapPin, LocateFixed, Siren, X } from "lucide-react";
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Button type="button" variant="outline" className="w-full h-full flex flex-col justify-center items-center min-h-[112px]" disabled>
